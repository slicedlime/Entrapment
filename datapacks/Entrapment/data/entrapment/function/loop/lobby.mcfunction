...
execute at @e[type=armor_stand,name=JoinNone] run particle minecraft:entity_effect{color:[0.4f,0.4f,0.4f,1f]} ~ ~1 ~ 1 1 1 0 5 force
...
tellraw @a[tag=!HasPreviouslyJoined] ["",{"text":"\nGreetings and welcome to "},{"text":"Entrapment","color":"green"},{"text":" by "},{"text":"slicedlime","color":"gold","clickEvent":{"action":"open_url","value":"http://www.youtube.com/slicedlime"},"hoverEvent":{"action":"show_text","value":{"text":"","extra":[{"text":"slicedlime on YouTube"}]}}},{"text":". If you want\nhelp, please "},{"text":"click here","color":"gold","clickEvent":{"action":"run_command","value":"/trigger Help set 1"},"hoverEvent":{"action":"show_text","value":{"text":"","extra":[{"text":"Display help"}]}}},{"text":" or click the Help sign in the lobby.\n"}]
...
execute if entity @a[scores={Op=1}] run tellraw @a[scores={Op=1..}] ["",{"selector":"@a[scores={Op=1}]","color":"yellow"},{"text":" is now a game operator."}]
...
# Silence item frames
execute as @e[type=item_frame] run data merge entity @s {Silent:1b}
