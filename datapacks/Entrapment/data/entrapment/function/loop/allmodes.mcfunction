...
execute unless entity @e[type=armor_stand,name=JoinRed] run summon armor_stand 1011 2 3 {CustomName:'"JoinRed"',Marker:1b,NoGravity:1b,Invisible:1b}
scoreboard players set @e[type=armor_stand,name=JoinRed] Team 1

execute unless entity @e[type=armor_stand,name=JoinBlue] run summon armor_stand 1011 2 2 {CustomName:'"JoinBlue"',Marker:1b,NoGravity:1b,Invisible:1b}
