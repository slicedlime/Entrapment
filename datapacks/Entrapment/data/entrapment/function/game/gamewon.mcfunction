...
data merge block 3 253 144 {front_text:{messages:['{"text":"Arena:","color":"white"}','{"text":"No Arena","color":"gold","clickEvent":{"action":"run_command","value":"/trigger Action set 1"}}','""','""']}}
