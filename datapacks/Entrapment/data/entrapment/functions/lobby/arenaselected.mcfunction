...
# Update sign
execute at @e[scores={Selected=1}] run data merge block 3 253 144 {Text1:'{"text":"Arena:"}',Text2:'{"text":""}',Text3:'[{"selector":"@e[scores={Selected=1..,Arena=1..}]","color":"blue","clickEvent":{"action":"run_command","value":"trigger Action set 1"}}]',Text4:'[{"text":"by "},{"nbt":"ArmorItems[3].tag.author","entity":"@e[type=armor_stand,scores={Selected=1},sort=nearest,limit=1]","interpret":true,"color":"blue"}]'}
